...
resource "aws_route" "internet_access" {
  route_table_id         = "${aws_vpc.uat.main_route_table_id}"
...
resource "aws_security_group" "uat" {
  ...
  description = "EGAR UAT Security Group"
  vpc_id      = "${aws_vpc.uat.id}"
...
resource "aws_instance" "web" {
  ...
  vpc_security_group_ids = ["${aws_security_group.uat.id}"]
